...
urlpatterns = patterns('',
   ...
   # url(r'^studies/download/GSE(?P<studynumber>\d+)/$', 'application.views.send_zipfile'),
    ...
    url(r'^studies/downloadsamples/(?P<studyid>\w+)/$', 'application.views.get_samples'),
    url(r'^studies/getAttrData/$', 'application.views.getAttrData'),
    url(r'^studies/formatting/$', 'application.views.format'),
    url(r'^studies/view/plot/(?P<studynumber>\w+)', 'application.views.singlePlot'),
    url(r'^studies/view/plotList/(?P<studynumber>\w+)', 'application.views.plotList'),
    url(r'^studies/getSingleAttrData/$', 'application.views.getSingleAttrData'),
    url(r'^studies/thumbnailsetup/$', 'application.views.thumbnails'),
    url(r'^studies/getAttributeKeys/$', 'application.views.getAttributeKeys'),
    url(r'^studies/downloadGraph/$', 'application.views.downloadGraph'),
    url(r'^studies/getGraph/$', 'application.views.getGraph'),
    url(r'^studies/uploadTest/$', 'application.views.uploadTest'),
    url(r'^studies/dashboard/(?P<studynumber>\w+)/$', 'application.views.dashboard'),
)
